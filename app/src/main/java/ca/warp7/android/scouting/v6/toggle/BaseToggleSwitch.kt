...
abstract class BaseToggleSwitch : LinearLayout, ToggleSwitchButton.Listener {
    ...
    companion object Default {
        ...
        @JvmStatic private val EMPTY_TOGGLE_DECORATOR      = object:
            ToggleSwitchButton.ToggleSwitchButtonDecorator {
    ...
    var prepareDecorator: ToggleSwitchButton.ToggleSwitchButtonDecorator =
        EMPTY_TOGGLE_DECORATOR
    ...
    constructor(context: Context) : super(context) {
        ...
        // Set default params
        checkedBackgroundColor       = ContextCompat.getColor(context,
            CHECKED_BACKGROUND_COLOR
        )
        checkedBorderColor           = ContextCompat.getColor(context,
            CHECKED_BORDER_COLOR
        )
        checkedTextColor             = ContextCompat.getColor(context,
            CHECKED_TEXT_COLOR
        )

        borderRadius                = dp2px(
            context,
            BORDER_RADIUS_DP.toFloat()
        )
        borderWidth                 = dp2px(
            context,
        ...
        uncheckedBackgroundColor     = ContextCompat.getColor(context,
            UNCHECKED_BACKGROUND_COLOR
        )
        uncheckedBorderColor         = ContextCompat.getColor(context,
            UNCHECKED_BORDER_COLOR
        )
        uncheckedTextColor           = ContextCompat.getColor(context,
            UNCHECKED_TEXT_COLOR
        )

        separatorColor              = ContextCompat.getColor(context,
            SEPARATOR_COLOR
        )
    ...
    fun setView(layoutId: Int, numEntries: Int,
        ...
        for (index in 0..numEntries - 1) {
            ...
            val button = ToggleSwitchButton(
                context, index, positionType, this,

...
class TimedEntryTest {
    ...
    fun testNextIndex() {
        ...
        assertEquals(1, entry.getNextIndex(7.5))
        assertEquals(2, entry.getNextIndex(8.0))
        assertEquals(2, entry.getNextIndex(9.0))
        assertEquals(0, entry.getNextIndex(0.0))
        assertEquals(3, entry.getNextIndex(10.0))
    }
    ...
    fun testNextIndexSameTime() {
        ...
        assertEquals(0, entry.getNextIndex(7.0))
        assertEquals(1, entry.getNextIndex(7.1))
    }
